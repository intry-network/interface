...
const plugins = [
  ...
  externals({ exclude: ['constants'], deps: true, peerDeps: true }), // marks builtins and dependencies as external
  ...
  plugins: [
    ...
    babel({
      ...
      plugins: [
        ...
        // TODO(zzmp): @uniswap sdk's break webpack v6 by importing named imports from abi JSON files.
        ['@babel/plugin-transform-runtime', { useESModules: format === 'esm' }], // embeds the babel runtime for library distribution
      ],
    }),
